...
namespace UnitTests.RepositoryTests
{
    ...
    public class ConsultationRepositoryTests
    {
        ...
        public void SetUp()
        {
            ...
            {
                 new Consultation { Id = 1, PatientName = "Juana", 
                                    PatientBirthDate = new DateTime(1990, 01, 01), 
                                    PatientEmail = "juana@hotmail.com", PatientPhone = "098765432" },
                 new Consultation { Id = 2, PatientName = "Victor", 
                                    PatientBirthDate = new DateTime(1989,02,02), 
                                    PatientEmail = "victor@hotmail.com", PatientPhone = "02345678" }
            }.AsQueryable();
        ...
        public void GetAllTest()
        {
            ...
            Assert.AreEqual(2, consultation.ToList().Count);
        }
        ...
        public void GetByIdTest()
        {
            ...
            Assert.AreEqual("juana@hotmail.com", consultation.PatientEmail);
        }

        [TestMethod]
        public void AddConsultationTest()
        {
            var consultation = new Consultation { Id = 3, PatientName = "Pablo", 
        ...
        public void UpdateConsultationTest()
        {
            ...
            mockContext.Verify(e => e.SaveChanges(), Times.Once());
            Assert.AreEqual("juana@gmail.com", modifiedConsultation.PatientEmail);
        }
